package daomephsta.zenloot.test;
...
import daomephsta.zenloot.test.support.zenscript.CraftTweakerLoggerRedirect;
import daomephsta.zenloot.test.support.zenscript.ScriptRunner;
...
public class ZenscriptSmokeTests
{
    ...
    public static final CraftTweakerLoggerRedirect redirect = new CraftTweakerLoggerRedirect(
        LogManager.getFormatterLogger("Saddle.ZenLoot"));
