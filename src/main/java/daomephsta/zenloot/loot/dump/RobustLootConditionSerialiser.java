package daomephsta.zenloot.loot.dump;
...
import daomephsta.zenloot.mixin.LootConditionManagerAccessors;
...
{
    private static final Logger SANITY_LOGGER = LogManager.getLogger(ZenLoot.ID + ".sanity_checks");
