...
public class SubcommandGenerate implements Subcommand
{
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args)
    {
        if (args.length < 2)
        {
            sender.sendMessage(ZenLoot.translation(".commands.generate.type"));
            return;
        }
        String type = args[1];
        if (args.length < 3)
        ...
        {
            sender.sendMessage(ZenLoot.translation(".messages.error.invalidTableName", tableId));
            return;
        }
        ...
        ResourceLocation tableId)
    {
        if (args.length < 4)
        {
            sender.sendMessage(ZenLoot.translation(".commands.generate.missingEntityId"));
            return;
        }
        ...
        if (args.length == 5)
        {
            ...
            {
                sender.sendMessage(ZenLoot.translation(".commands.generate.nbtError"));
        ...
        {
            sender.sendMessage(ZenLoot.translation(".commands.generate.invalidEntityId", id));
            return;
        }
