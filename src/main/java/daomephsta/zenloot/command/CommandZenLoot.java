...
public class CommandZenLoot extends CraftTweakerCommand
{
    ...
    protected void init()
    {
        setDescription(ZenLoot.translation(".commands.dump.desc"));
    }
    ...
    public void executeCommand(MinecraftServer server, ICommandSender sender, String[] args)
    {
        if (args.length < 1)
        {
            sender.sendMessage(ZenLoot.translation(".commands.dump.usage"));
            return;
        }
        ...
        if (subcommand != null)
        {
            ...
            sender.sendMessage(ZenLoot.translation(".commands.dump.unknownSubcommand", args[0]));
    }
