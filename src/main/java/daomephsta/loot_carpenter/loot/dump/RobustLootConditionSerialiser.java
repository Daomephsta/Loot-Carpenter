package daomephsta.loot_carpenter.loot.dump;
...
import daomephsta.loot_carpenter.mixin.LootConditionManagerAccessors;
...
{
    private static final Logger SANITY_LOGGER = LogManager.getLogger(LootCarpenter.ID + ".sanity_checks");
