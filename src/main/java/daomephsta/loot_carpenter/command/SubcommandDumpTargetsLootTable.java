...
import daomephsta.loot_carpenter.mixin.EntityLivingAccessors;
...
public class SubcommandDumpTargetsLootTable implements Subcommand
{
        ...
        if (sender instanceof Entity)
        {
            ...
            case BLOCK:
                ...
                if (te instanceof ILootContainer)
                {
                    ...
                    sender.sendMessage(LootCarpenter.translation(".commands.dump.target.noTable"));
                break;
            case ENTITY:
                ...
                break;
            case MISS:
                sender.sendMessage(LootCarpenter.translation(".commands.dump.target.noTarget"));
                return;
            default:
                return;
            }
            ...
            sender.sendMessage(LootCarpenter.translation(".commands.dump.target.senderNotEntity"));
    }
    ...
    {
        sender.sendMessage(LootCarpenter.translation(".commands.dump.dumpLink",
